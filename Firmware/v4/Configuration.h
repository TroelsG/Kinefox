...
#define ACTIVATION_COUNT									6 // min 2	 
#define SLEEP_COUNT									        6	
#define RESEND_COUNT									    3		
#define SHORT_SLEEP										    3600	//3600
...
#define GET_FIX_TIMEOUT_SECONDS								254		// 254/100, only when tracking frequency > 5 ("sometimes"), timeout until GPS attempt is canceled

...
#define BATT_VOLT_RES_1							47UL 			// in MOhm * 10 (47 = 4.7MOhm)
#define BATT_VOLT_RES_2							100UL			// in MOhm * 10
...
uint16_t deviceReadSupplyVoltageADC(); // minimum 100kHz CPU clock speed and after prescaler between 50kHz and 1.5MHz (for max resolution), in V*1000 (2700 = 2.7V)

// Read temperature
#if defined (__AVR_ATtiny1626__)
int16_t getInternalTemperature(); // returns full degree in Celsius
#endif
// Measure time
